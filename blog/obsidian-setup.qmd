...
In the current setup, I could easily copy a markdown file from my Obsidian journal into my Quarto website project. Some friction remains, though, having to switch between the different flavours of markdown. For example, compare the syntax for callouts in Quarto vs. Obsidian: 
